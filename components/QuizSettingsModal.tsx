...
export type QuizLanguageType = 'EN' | 'VN' | 'Mixed';
...
export const QuizSettingsModal: React.FC<QuizSettingsModalProps> = ({ settings, maxQuestions, onUpdate, onReset, onClose, showHeader = true }) => {
    const { t } = useLanguage();

    const handleUpdate = (key: keyof QuizSettings, value: any) => {
